        ...
        <div className={ classes.grid }>
          <div className={ classes['text-container'] }>
            ...
            <div className={ classes.icons }>
              ...
              <a href="mailto:adryan.lmrosa@gmail.com" target="_blank" rel="noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="bi bi-envelope" viewBox="0 0 16 16">
        ...
        <div className={ classes.buttons }>
          <Button>
            <div className={ classes['button-flex'] }>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="1.125em" height="1.125em" fill="currentColor" className="bi bi-arrow-down" viewBox="0 0 16 16">
